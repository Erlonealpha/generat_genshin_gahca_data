...
df_gacha_char_group = df_gacha_char.groupby('uigf_gacha_type')
df_gacha_weapon = df_gacha_weapon.groupby('uigf_gacha_type')
...
limited_cur_char_dic = {
    '琴':         [79, ['2020-12-23 18:00:00', '2021-01-12 00:00:00']], # 第一个五星
    '魈':         [79, ['2021-02-03 18:00:00', '2021-02-23 00:00:00']], # 当时我居然为魈 -648, 好像还充了，忘了多少了
    '莫娜':       [80, ['2021-3-16 18:00:00']],                         # 有印象记得是什么时候出的时间区间为准确的一天 (这个我甚至记得是在什么时候出的, 没错就是在卡池刚开没多久)
    '胡桃':       [71, ['2021-3-16 18:00:00']],                         # 当时歪莫娜之后，立马充了648把胡桃抽出来了 QAQ
    '七七':       [33, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 好像是一天的中午刚强化完胡桃的圣遗物抽出来的, 还兴奋了挺久
    '钟离':       [76, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 具体时间记不清楚了，但肯定不是卡池出的那一天
    '七七':       [50, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 这个和优菈是几乎同时出的, 当时我直接跳起来了...
    '优菈':       [9,  ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 第一次10连双金
    '迪卢克':     [76, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 痛苦的经历，当时家里电脑暂时没法用了就去网吧抽可莉。 结果...
    '可莉':       [76, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 本人很喜欢可莉, 所以... -648...
    '枫原万叶':   [11, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 卡池刚开的时候应该是
    '琴':         [39, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 应该和上个卡池隔了半个版本
    '神里绫华':   [20, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 好像是卡池第二天
    '宵宫':       [39, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 应该是卡池刚出的时候
    '珊瑚宫心海': [75, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 卡池前中期？
    '胡桃':       [77, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 卡池中后期？
    '阿贝多':     [36, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 应该是卡池刚开的时候
    '申鹤':       [77, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 卡池前中期
    '甘雨':       [53, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 卡池第一天or刚开卡池
    '八重神子':   [74, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 卡池第一天or第二天
    '雷电将军':   [72, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 卡池前中期
    '刻晴':       [39, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 卡池前期  终结了9连没歪
    '夜兰':       [80, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']],  # 应该是卡池末期
    '':           [17, ['2021-02-23 18:00:00', '2021-3-16 00:00:00']]   # 这个是未出货抽数 #TODO 这里的数据和之后的数据合并可能会出现保底大于180的情况, 得特殊处理
